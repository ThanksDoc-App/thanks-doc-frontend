...
import { getAccountDetails } from '@/views/account/Settings/store/SettingsSlice'
...
const Billing = () => {
    ...
    // Get account details from Redux store
    ...
    useEffect(() => {
        fetchData()
        dispatch(getAccountDetails()) // Fetch account details
                                    ...
                                    {({
                                        ...
                                        return (
                                            <CreditCardForm
                                                ...
                                                // Pass account details directly from the data structure
                                                accountDetails={
