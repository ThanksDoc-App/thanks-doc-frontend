...
const generalNotificationForm = [
    { label: 'Notifications preference', name: 'news' },
    ...
    return (
        ...
        >
            ...
            >
                ...
                <span className="hidden sm:block ltr:ml-2 rtl:mr-2">Applications</span>
            </Segment.Item>
            <Segment.Item
                className="flex items-center justify-center"
                type="button"
            ...
            >
                ...
                <span className="hidden sm:block  ltr:ml-2 rtl:mr-2">Recommendation</span>
            </Segment.Item>
        </Segment>
    )
}
                    ...
                    <Form>
                        <FormContainer>
                            <FormDesription
                                ...
                                desc="This is notifications preferences that you can update anytime."
                            />
                            <Rows
